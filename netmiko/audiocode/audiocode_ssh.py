...
class AudiocodeSSH (BaseConnection):
	...
	def disable_paging(
		self, 
		disable_window_config = ["cli-settings","window-height 0","exit","exit"],
		...
		self.send_config_set(disable_window_config,False,.25,150,False,False,config_mode,False,False)
		log.debug("Exiting disable_paging")

		
	def _enable_paging(
		self, 
		enable_window_config = ["cli-settings","window-height automatic","exit","exit"],
		config_mode = "config system",
		delay_factor=.5
	):
		...
		self.send_config_set(enable_window_config,False,.25,150,False,False,config_mode,False,False)
...
class AudiocodeOldCLI(AudiocodeSSH):
	...
	def disable_paging(
		self, 
		disable_window_config = ["cli-terminal","set window-height 0","exit","exit"],
		config_mode = "config system",
		delay_factor=.5
	):
		"""This is designed to disable window paging which prevents paged command 
	...
	def _enable_paging(
		self, 
		enable_window_config = ["cli-terminal","set window-height 100","exit","exit"],
		config_mode = "config system",
		delay_factor=.5
	):
		"""This is designed to reenable window paging
