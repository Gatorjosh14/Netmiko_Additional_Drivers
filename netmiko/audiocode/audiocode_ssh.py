...
class AudiocodeSSH (BaseConnection):
	...
	def disable_paging(
		...
		self.send_config_set(disable_window_config,True,.25,150,False,False,config_mode,False,False)
	...
	def _enable_paging(
		...
		self.send_config_set(enable_window_config,True,.25,150,False,False,config_mode,False,False)
